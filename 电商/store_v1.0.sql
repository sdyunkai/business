...
MySQL - 5.5.53 : Database - onlineshop
*********************************************************************
*/
...
insert  into `user`(`uid`,`username`,`password`,`name`,`email`,`telephone`,`birthday`,`sex`,`state`,`code`) values ('a6417a45112a481bbde72b4c96bc5cbc','云开','123456','liuyong','it_liuyong@163.com',NULL,'1988-10-10','male',1,'6f40e93591f34b73889702a316490ddb');
